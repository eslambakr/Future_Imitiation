"""
--input_dir /media/eslam/426b7820-cb81-4c46-9430-be5429970ddb/home/eslam/Future_Imitiation/Intel_dataset/videos/
--train_test_list_dir /media/eslam/426b7820-cb81-4c46-9430-be5429970ddb/home/eslam/Future_Imitiation/Intel_dataset/
--output_dir /media/eslam/426b7820-cb81-4c46-9430-be5429970ddb/home/eslam/Future_Imitiation/Intel_dataset/tf_record
--num_workers 4
"""
import argparse
import glob
...
class carla_intel_VideoDataset(VarLenFeatureVideoDataset):
    def __init__(self, *args, **kwargs):
        super(carla_intel_VideoDataset, self).__init__(*args, **kwargs)
        self.state_like_names_and_shapes['images'] = 'images/encoded', (64, 64, 3)

    def get_default_hparams_dict(self):
        default_hparams = super(carla_intel_VideoDataset, self).get_default_hparams_dict()
        hparams = dict(
            context_frames=4,
            sequence_length=8,
            random_crop_size=0,
